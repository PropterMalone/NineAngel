...
Short names: `naive`, `adv`, `hyper`, `blindspot`, `future`, `rtfm`, `user`, `test`, `data-int`, `perf`, `coach`, `editor`, `rigor` (default-yes); `install`, `thousand`, `fresh`, `heir`, `penny`, `pii`, `deanon` (opt-in; experimental: `heir`, `penny`, `pii`, `deanon`).
